...
public class EchoCountSeekbarPreference extends SeekBarPreference {
	private final int minimum = SettingRanges.minimumEchoCount;
	private final int maximum = SettingRanges.maximumEchoCount;
	...
	protected int getPreferenceValue() {
		...
		int preferenceValue = preferences.getInt(SettingNames.echoCount, DefaultSettings.echoCount);
